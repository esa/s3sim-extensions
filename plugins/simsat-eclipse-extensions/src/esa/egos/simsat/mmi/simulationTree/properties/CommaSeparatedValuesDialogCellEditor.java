 ...
 * @author Jean Schuetz
 */
public class CommaSeparatedValuesDialogCellEditor extends CustomisedDialogCellEditor
{
    ...
    /**
     * Creates a new Comma Separated Values cell editor parented under the given
     * control. The cell editor value is the string itself, which is initially
     * the empty string. Initially, the cell editor has no cell validator.
     * 
     * @param parent
     *            the parent control
     */
    public CommaSeparatedValuesDialogCellEditor(Composite parent)
    {
     ...
     * @since 2.1
     */
    public CommaSeparatedValuesDialogCellEditor(Composite parent, int style)
    {
        super(parent, style);
    }
    ...
    protected Object openDialogBox(Control cellEditorWindow)
    {
        ...
        CommaSeparatedValues scvValues = new CommaSeparatedValues(text.getText());
        CommaSeparatedValuesDialog dlg = new CommaSeparatedValuesDialog(cellEditorWindow.getShell(), scvValues
                .getTokens());
        if (dlg.open() == CommaSeparatedValuesDialog.CANCEL)
        {
            return null;
        }
    ...
    protected Control createContents(Composite cell) {
        text = new Text(cell, SWT.LEFT|SWT.SINGLE);
        ...
        text.addFocusListener(new FocusAdapter() {
            ...
            {
                CommaSeparatedValuesDialogCellEditor.this.focusLost();
            }
        });
    ...
    protected void editOccured(ModifyEvent e)
    {
        ...
        assert !(typedValue == null && newValidState) : "Validator isn't limiting the cell editor's type range";//$NON-NLS-1$
...
// Revision 1.7  2008/03/05 14:03:07  mrc
// Modified 'openDialogBox(Control)' method in order to not terminate the returned value with a semi-colon.
//
// Revision 1.6  2007/01/29 17:34:39  jsc
// modified code in order to use the patched CustomisedDialogCellEditor.
//
// Revision 1.5  2007/01/23 17:05:27  jsc
// completely rewrote the class
//
//